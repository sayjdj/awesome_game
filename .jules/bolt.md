...
## 2024-05-24 - CSS @import Render-Blocking Chains
**Learning:** Using `@import` to load external fonts in CSS files creates a serial request chain (HTML -> CSS -> Font CSS), which delays rendering.
